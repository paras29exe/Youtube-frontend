        ...
        <>
            <nav className="bg-customDark navbar z-20 top-0 px-3 py-4 text-center flex items-center justify-between max-xl:px-5">
                ...
                <div className='w-1/5 flex items-center justify-end gap-x-8 pr-4 '>
                    ...
                    <div className='bg-blue-400/30 rounded-full w-12 h-12 cursor-pointer flex items-center justify-center ' onClick={toggleLoginPage}>
                        {
                            userData?.data.user.avatar ?
                                <img src={userData.data.user.avatar} className="object-cover rounded-full w-full h-full " alt='avatar' />
