...
function SideBar() {
    ...
    return (
        <div
            id='sidebar'
            className={`z-20 pt-5 backdrop-blur-sm transition-all duration-200 ease-in-out h-screen overflow-y-auto px-1.5 box-border
                ${!pathname.includes("/videos/play") && "sm:min-w-52 sm:max-w-52 sm:bg-black/60 md2:bg-inherit md2:relative md2:min-w-20 md2:max-w-20 lg2:min-w-52 lg2:max-w-52"}
        ...
        >
            ...
            <div className={`select-none flex items-center gap-2 p-3 md2:hidden lg2:flex ${sidebarSize === "small" ? "!hidden" : ""}`}>
