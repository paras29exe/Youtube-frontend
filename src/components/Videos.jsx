        ...
        <div className='w-full overflow-y-auto overflow-x-hidden px-2 flex flex-wrap content-start pb-20'>
            {
                videos.map((video) => {
                    return (
                        ...
                        >
                            <div className="relative overflow-hidden rounded-lg mb-2 flex-grow min-w-full max-w-full">
                                <img
                                    ...
                                    alt="Video thumbnail"
                                />
                                <div className="absolute bottom-1 right-3 bg-black/70 px-1.5 py-0.5 font-semibold text-xs rounded-sm">
                                    20:50
                                </div>
                            </div>
