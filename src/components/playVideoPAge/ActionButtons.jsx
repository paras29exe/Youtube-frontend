...
function ActionButtons({ currentVideo }) {
    ...
    return (
        <div className='overflow-x-auto'>
            <div className=" flex items-center justify-between gap-x-8 mt-2 max-sm:min-w-[550px]">
                {/* channel details */}
                <div className="flex items-center w-1/2 gap-x-4 ">

                    <div className='flex items-center gap-x-2 whitespace-nowrap min-w-fit'>
                        <img
                            onClick={(e) => {
                                e.stopPropagation()
                        ...
                        />
                        <div className="">
                            <span className="font-bold mr-1 text-base line-clamp-1">{currentVideo.channelDetails.channelName}</span>
                        ...
                        <button
...

                            {
                                isDisliked ? <FaThumbsDown className={`text-lg transition-all duration-300 -scale-x-100 fill-blue-600 `} />
                                    : <FaRegThumbsDown className="text-lg -scale-x-100 transition-all duration-300 " />
                            }
                        </button>
                    </div>
